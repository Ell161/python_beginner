...
def find_rhythm_phrase(phrase: str):
    ru_vowels = set('ауоыиэяюёе')
    en_vowels = set('aeiou')
    count_vowels = 0
    for letter in phrase:
        if letter in ru_vowels or letter in en_vowels:
            count_vowels += 1
    return count_vowels


syllables = map(find_rhythm_phrase, input('Напишите стихотворение: ').split())
